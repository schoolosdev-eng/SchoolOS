...
class OfflineAttendanceDb extends Dexie {
  ...
  constructor() {
    ...
    this.version(7).stores({
      ...
      attendance:
        'id, school_id, student_id, class_id, attendance_date, [student_id+attendance_date], [student_id+class_id+attendance_date], synced',
      earlyExits:
        'id, school_id, student_id, class_id, exit_date, synced',
      faceCapturesTemp: null,
      faceEmbeddings: null,
      faceAttendanceAttempts: null,
    })
  }
}
